...
<body style="margin:0;padding:0;background:#f9f6f2;font-family:'Helvetica Neue',Arial,sans-serif;">
  ...
  static async notifyInstructorOfNewSessionRequest({
    name,
    subject,
    email
  }: {
      ...
      <td align="center">
        ...
        >
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#d96b3a,#e8924a);padding:36px 40px;text-align:center;">
              <img
                src="https://pub-89b1de93308a45efb0b4e47ee91424a6.r2.dev/uploads/android-chrome-512x512.png"
                alt="BookYourYogaTeacher"
                width="56"
                height="56"
                style="display:block;margin:0 auto 14px;border-radius:14px;"
              />
              ...
              <p
                style="margin:0;font-size:13px;font-weight:700;letter-spacing:.2em;text-transform:uppercase;color:rgba(255,255,255,.85);"
              >
                BookYourYogaTeacher
              </p>

              <p
                style="margin:6px 0 0;font-size:18px;font-weight:700;color:#fff;"
              >
                ${subject}
              </p>
            </td>
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <p
                style="margin:0 0 16px;font-size:15px;color:#555;line-height:1.7;"
              >
                A new yoga session has been assigned to you.
              </p>

              <p
                style="margin:0 0 28px;font-size:15px;color:#555;line-height:1.7;"
              >
                Please log in to your instructor dashboard to review the session
                details, check the scheduled date and time, and prepare for your
                upcoming class.
              </p>
              ...
              <table cellpadding="0" cellspacing="0" style="margin:0 auto 28px;">
                <tr>
                  <td style="background:linear-gradient(135deg,#d96b3a,#e8924a);border-radius:12px;">
                    <a
                      href="https://bookyouryogateacher.com/instructor/dashboard"
                      target="_blank"
                      style="display:inline-block;padding:15px 40px;font-size:15px;font-weight:700;color:#fff;text-decoration:none;letter-spacing:.01em;"
                    >
              ...
              >
                <tr>
                  <td style="padding:16px 20px;">
                    <p
                      style="margin:0 0 6px;font-size:12px;color:#888;font-weight:600;text-transform:uppercase;letter-spacing:.06em;"
                    >
                      Or copy this link into your browser
                    </p>

                    <p
                      style="margin:0;font-size:12px;line-height:1.6;word-break:break-all;"
                    >
                      <a
                        href="https://bookyouryogateacher.com/instructor/dashboard"
                        target="_blank"
                        style="color:#c26030;text-decoration:none;"
                      >
                        https://bookyouryogateacher.com/instructor/dashboard
                      </a>
                    </p>
                  </td>
                </tr>
              ...
              <p
                style="margin:0;font-size:13px;color:#999;line-height:1.7;"
              >
                Thank you for being a valued instructor with
                <strong>BookYourYogaTeacher</strong>. We appreciate your dedication
                and wish you a wonderful session.
              </p>
          ...
          <tr>
            <td
              style="padding:20px 40px 32px;border-top:1px solid #f0ece8;"
            >
              <p
                style="margin:0;font-size:12px;color:#aaa;text-align:center;"
              >
                BookYourYogaTeacher · Breathe. Move. Grow.
              </p>
            </td>
