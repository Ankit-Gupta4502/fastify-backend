...
import { useAdminInstructors, useCreateInstructor } from "@/features/admin/hooks/use-admin";
import { InstructorsTable } from "@/features/admin/components/instructors-table";
