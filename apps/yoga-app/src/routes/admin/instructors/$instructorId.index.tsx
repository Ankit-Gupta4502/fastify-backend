...
function AdminInstructorDetailPage() {
  ...
  const { data, isLoading, isFetching, error } = useAdminInstructorDetail(instructorId, {
    page,
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          ...
          <SectionCard title={`Sessions (${instructor.sessions.total})`}>
            <InstructorSessionsSection
              instructorId={instructor.id}
              sessions={instructor.sessions.items}
              page={instructor.sessions.page}
              pageSize={instructor.sessions.pageSize}
              total={instructor.sessions.total}
