...
export const FALLBACK_REVIEWS: PublicReview[] = [
  { id: "f1", rating: 5, userName: "Sarah Chen",      comment: "Book Your Yoga Teacher has completely transformed how I manage my studio. It feels like the app actually breathes with my classes.", createdAt: "" },
  ...
  { id: "f5", rating: 5, userName: "Aisha Jallow",    comment: "A beautiful blend of technology and zen. Book Your Yoga Teacher doesn't just manage data — it manages energy. Nothing else comes close.", createdAt: "" },
